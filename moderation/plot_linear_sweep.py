...
METRICS_PATH = os.path.join(HERE, "linear", "models", "metrics.json")
...
ax.set_title("Linear classifier performance across feature dimensions", fontsize=13, fontweight='bold', pad=15)

# Y-limits and ticks (starting at 0.50 to accommodate low recall at d=64)
ax.set_ylim(0.50, 1.01)
y_ticks = [0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80, 0.85, 0.90, 0.95, 1.00]
...
# Precision
prec_offsets = [6, 6, -14] # at d=1024, precision is 0.96 (below accuracy 0.97)
...
plt.tight_layout()
plt.savefig(os.path.join(HERE, "linear_classifier_sweep.png"), dpi=300)
print("Saved linear_classifier_sweep.png")
